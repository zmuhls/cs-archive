...
.browse-options h3, .collection-links h3 {
  margin: 0;
}

.browse-options h3 a, .collection-links h3 a {
  display: block;
  padding: 1rem;
  background: #f8f8f8;
...
.browse-options h3 a:hover, .collection-links h3 a:hover {
  background: #333;
  color: white;
  border-color: #333;
}

.browse-options p, .collection-links p {
  font-size: 0.9rem;
  color: #666;
  margin: 0.5rem 0 0 0;
}

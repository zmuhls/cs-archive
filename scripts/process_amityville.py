...
logger.add(
    "logs/amityville_processing_{time}.log",
    rotation="10 MB",
    level="DEBUG",
...
async def process_amityville():
    ...
    pdf_path = Path("raw/scans/NYS Archives/A4456/Amityville-Records.pdf")
    ...
    report_path = Path("output/ocr/reports/amityville_processing_report.json")
...
if __name__ == "__main__":
    asyncio.run(process_amityville())

...
### phase 2: training infrastructure (current)
...
### phase 3: fine-tuning experiments (next)
- baseline evaluation on raw model
- fine-tuning runs per document type
- cross-document-type transfer experiments
- hyperparameter sensitivity analysis

### phase 4: evaluation and publication (planned)
- CER/WER benchmarking against commercial OCR

...
COLLECTIONS_DIR = PROJECT_ROOT / 'output' / 'collections'
...
def convert_relative_to_media_url(relative_path: str) -> str:
    ...
    Example:
        ../../raw/scans/Kheel Center/img/IMG_0625.jpeg
        → https://media.githubusercontent.com/media/zmuhls/cs-archive/main/raw/scans/Kheel Center/img/IMG_0625.jpeg
    """
...
def extract_filename_from_url(url: str) -> str:
    ...
    if 'dropbox.com' in url:
        ...
        if match:
            return f"raw/scans/Kheel Center/img/{match.group(1)}"

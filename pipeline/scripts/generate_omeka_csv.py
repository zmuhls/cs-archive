...
def extract_image_filename(url: str) -> str:
    ...
    # e.g., https://github.com/zmuhls/cs-archive/blob/main/raw/scans/Kheel Center/img/IMG_0625.jpeg -> IMG_0625.jpeg
    parts = url.split('/')
    if parts:
        return parts[-1]
    return ""
...
def get_github_raw_url(filename: str, is_table: bool = False) -> str:
    ...
    if is_table:
        ...
        # Regular images are in raw/scans/Kheel Center/img/
        return f"https://raw.githubusercontent.com/zmuhls/cs-archive/main/raw/scans/Kheel Center/img/{filename}"

...
IN_CSV = PROJECT_ROOT / 'csv' / 'images_inventory.csv'
IN_RESP = PROJECT_ROOT / 'prompts' / 'images_label_responses.jsonl'
OUT_CSV = PROJECT_ROOT / 'csv' / 'images_inventory_labeled.csv'

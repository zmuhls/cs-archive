...
METADATA_DIR = PROJECT_ROOT / "output" / "ocr" / "metadata"
MARKDOWN_DIR = PROJECT_ROOT / "output" / "ocr" / "markdown"
THUMBS_DIR = PROJECT_ROOT / "derived" / "thumbs"
TABLES_THUMBS_DIR = PROJECT_ROOT / "output" / "ocr" / "tables" / "thumbs"

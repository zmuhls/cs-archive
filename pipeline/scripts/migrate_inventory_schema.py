...
IN_CSV = PROJECT_ROOT / 'csv' / 'images_inventory_labeled.csv'
OUT_CSV = PROJECT_ROOT / 'csv' / 'images_inventory_labeled.csv'  # overwrite in place
BACKUP_CSV = PROJECT_ROOT / 'csv' / 'images_inventory_labeled.backup.csv'
